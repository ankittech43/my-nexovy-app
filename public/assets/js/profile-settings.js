				...
				'<div class="row form-row">' +
					...
					'<div class="col-12 col-md-6 col-lg-4">' +
						'<div class="form-group">' +
							...
							'<input type="number" id="year" name="year[]" min="1900" max="2099" step="1" value="2018" class="form-control">' +
						'</div>' +
					'</div>' +
				'</div>' +
			'</div>' +
    ...
    $(".add-award").on('click', function () {
        ...
        var regcontent = '<div class="row form-row awards-cont">' +
			...
			'<div class="col-12 col-md-5">' +
				'<div class="form-group">' +
					'<label>Year</label>' +
					'<input type="text" id="award_year" name="award_year[]" min="1900" max="2099" step="1" value="2018" class="form-control">' +
				'</div>' +
			'</div>' +
        ...
        var membershipcontent = '<div class="row form-row membership-cont">' +
			'<div class="col-12 col-md-10 col-lg-5">' +
				'<div class="form-group">' +
					...
					'<input type="text" name="memberships[]" id="memberships" class="form-control">' +
				'</div>' +
			'</div>' +
    ...
    $(".add-reg").on('click', function () {
        ...
        var regcontent = '<div class="row form-row reg-cont">' +
			...
			'<div class="col-12 col-md-5">' +
				'<div class="form-group">' +
					'<label>Year</label>' +
					'<input type="text" name="registration_year[]" min="1900" max="2099" step="1" value="2018" id="registration_year" class="form-control">' +
				'</div>' +
			'</div>' +
			'<div class="col-12 col-md-2">' +
				'<label class="d-md-block d-sm-none d-none">&nbsp;</label>' +
