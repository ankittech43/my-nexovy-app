        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8 col-12">
                    ...
                    <h2 class="breadcrumb-title">{{count($doctorList)}} matches found  {{--for : Dentist In Bangalore--}}</h2>
                </div>
                              ...
                              @foreach($doctorSpeciality as $specility)
                                <div>
                                    <label class="custom_check">
                                        ...
                                        <span class="checkmark"></span> {{$specility->Speciality}}
                                    </label>
                                </div>
                                @endforeach
                                ...
                                <div class="doctor-widget">
                                    <div class="doc-info-left">
                                        ...
                                        <div class="doc-info-cont">
                                            <h4 class="doc-name"><a href="doctor-profile">Dr. {{$list->doctors['DoctorName']}}</a></h4>
                                            ...
                                            <div class="clinic-details">
                                                <p class="doc-location"><i class="fas fa-map-marker-alt"></i> {{$list->doctors['Area']}},
                                                    {{$list->doctors['City']}}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="doc-info-right">
                                        ...
                                        <div class="clinic-booking">
                                            ...
                                            <a class="apt-btn" href="{{url('employee/Doctorbooking/'.$list->id)}}">Book Product</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
